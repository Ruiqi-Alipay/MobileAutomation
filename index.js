var webdriver = require('selenium-webdriver'),
    ...
    selendroidPath = 'selendroid-standalone.jar', //symbolic linked to selendroid-standalone-0.12.0-with-dependencies.jar
    appPath = '/Users/medelman/src/android/selendroid-test-app-0.10.0.apk',
    caps = {
        browserName: 'android',
...
function getServer() {
    var server = new SeleniumServer(selendroidPath, {
        ...
        args: ['-app', '/Users/medelman/src/android/selendroid-test-app-0.10.0.apk']
    });
    server.start();
